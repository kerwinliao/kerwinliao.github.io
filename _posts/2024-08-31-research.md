...
My research applies organization theory lens to analyzing creative industries (e.g., commercial music, movie, etc.), particularly the evolution of industries and how entrepreneurs shape and adapt to the market. I rely on empirical analysis and computational simulation (e.g., agent-based model, NK model) to examine the issues in this field. 
